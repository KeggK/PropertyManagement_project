...
<header class="bg-white">
        ...
        <nav class="relative md:mx-auto md:flex md:items-center md:justify-between py-4">
            <div class="flex flex-col lg:hidden" x-data="{open: false}">
                ...
                <div x-show="open" @click.outside="open = false">
                    <div class="absolute top-0 left-0 flex flex-col h-screen bg-white w-[40%] gap-y-5 divide-y text-gray-600 font-semibold uppercase">
            ...
            <div class="flex">
                <img class="h-10 w-full" src="https://hazaar.eu/wp-content/uploads/2023/12/logo-hazzar.svg" alt="hazaar logo">
                </a>
            ...
            <div class="">
                <ul class="flex items-center space-x-8">
                    <div class="hidden lg:flex">
                        ...
                        <li>
                            <a class="hover:text-green-700 p-5 hover:bg-black" href="{{route($item)}}">{{$key}}</a>
                        </li>
                        @endforeach
    ...
    <footer class="bg-white mt-6">
        ...
        <div class="max-w-screen-2xl px-4 lg:px-16 mx-auto">
            <p class="text-xs text-center text-gray-600">© Hazaar - Të gjitha të drejtat të rezervuara</p>
        </div>
    </footer>
</body>
