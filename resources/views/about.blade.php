...
@section('content')
    ...
    <div class="relative w-full h-[320px]" id="home">
        <div class="absolute inset-0 opacity-70">
            <img src="{{ asset('images/banner-image.png') }}" alt="Background Image"
                class="object-cover object-center w-full h-full" />

        </div>
        <div class="absolute inset-9 flex flex-col md:flex-row items-center justify-center">
            <div class=" mb-4 md:mb-0 grid place-content-center">
                <h1 class="text-5xl lg:text-[80px] text-orange-600 font-bold text-center">Elite Group</h1>
                <p class="font-bold text-2xl mb-8 mt-4 text-orange text-center">Zbuloni shtëpinë tuaj të ëndrrave me ne</p>
                <a href="#contactUs"
                    class="px-6 py-3 bg-black text-orange-600 font-medium text-center rounded-full transition duration-200">Na
                    kontaktoni</a>
            </div>
        </div>
    </div>
    ...
    <section class="bg-gray-100" id="aboutus">
        <div class="max-w-screen-2xl px-4 mx-auto lg:px-16 py-8 sm:px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 items-center bg-white rounded-lg">
                <div class="max-w-lg pl-3">
                    <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center">Rreth nesh</h2>
                    <p class="mt-4 text-gray-600 text-lg">
                        Shfletoni faqen tonë të internetit për të parë listat tona aktuale, duke përfshirë përshkrime të
                        hollësishme, fotografi të mahnitshme dhe ture virtuale që japin jetë secilës pronë. Ekipi ynë i
                        përvojësuar i profesionistëve të pasurive të patundshme është i angazhuar për të ofruar shërbim
                        personalizuar, sigurimin një përvojë të pafund në momentin që filloni kërkimin deri në ditën kur
                        hyni në shtëpi.

                        Në Grupin Elite të Pasurive të Patundshme, ne besojmë në krijimin e më shumë se vetëm shtëpive - ne
                        kuratojmë përvoja që e ngrisin jetën tuaj të përditshme. Qoftë se jeni duke blerë, duke shitur, ose
                        thjesht duke eksploruar, le të udhëheqim ju në rrugëtimin tuaj për të gjetur pronën perfekte.</p>
                </div>
    ...
    <!-- why us  -->
    <section class="text-gray-700  mt-10">
    ...
    <section class="bg-gray-100">
        <div class="max-w-screen-2xl mx-auto py-8 px-4 sm:px-6 lg:px-16 lg:py-20">
            ...
            <div class="mt-8 lg:mt-20">
                <div class="flex flex-col md:flex-row md:items-center">
                    ...
                    <div class="px-6 bg-white font-[sans-serif] py-3">
