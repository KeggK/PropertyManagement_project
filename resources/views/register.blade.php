    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto">
            <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                <img class="w-8 h-8 mr-2" src="../images/main-logo.png" alt="logo">
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('register-create') }}" method="POST">
                        ...
                        <div class="flex flex-row items0center gap-x-5">
                            <div class="w-full">
                                <label for="birthday"
                        ...
                        <div class="w-full">
                            ...
                            <select type="sex" name="sex" id="sex"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="gender">
                        ...
                        <button type="submit"
                            class="bg-black text-orange-500 px-5 py-3 rounded-md text-lg font-semibold">Create an
                            account</button>
