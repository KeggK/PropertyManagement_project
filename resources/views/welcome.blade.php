...
@section('content')
    ...
    <div class="">
        <div class="bg-local bg-cover bg-center bg-no-repeat" style="background-image: url('https://hazaar.eu/wp-content/uploads/2023/10/home-page-image.jpg');">
            <div class="">
                <div class="justify-center py-20">
                    <div class="max-w-screen-2xl px-4 lg:px-16 mx-auto py-20 items-center justify-center bg-stone-700 bg-opacity-50 rounded-md w-fit">
                        <div class="py-10 px-20">
                            ...
                            <div class="block md:flex bg-white rounded-md md:rounded-full p-2 justify-center items-center w-full md:w-fit space-y-3 md:space-y-0 md:space-x-3">
                            ...
                            <div class="block  md:flex my-5 w-full justify-items-center md:space-x-10 space-y-5 md:space-y-0 justify-between">
                                <div class="">
        ...
        <div class="flex mb-20">
            <div class="flex justify-between">
                <div class="flex flex-wrap ">
                    @for ($i = 0; $i < 3; $i++) <div class="md:w-1/2 lg:w-1/3">
                        <div class="mx-2 border-solid border-slate-200 border-2 rounded-lg bg-slate-50">
                            <a class="" href="">
                                <img class="w-full h-13" src="https://hazaar.eu/wp-content/uploads/2024/04/vila_3-2-584x438.jpg" alt="">
                            </a>
                            ...
                            <div>
                                <ul class="flex align-left py-3 px-7 gap-x-10">
                                    <div class="flex">
                                        <li class="mx-3">
                                            <img src="https://hazaar.eu/wp-content/uploads/2023/10/bed.png" alt="">
                                        </li>
                                        <li>
                                            <p>2</p>
                                        </li>
                                        <li class="mx-3">
                                            <img src="https://hazaar.eu/wp-content/uploads/2023/10/bathroom.png" alt="">
                                        </li>
                                        <li>
                                            <p>2</p>
                                        </li>
                                        <li class="mx-3">
                                            <img src="https://hazaar.eu/wp-content/uploads/2023/10/size.png" alt="">
                                        </li>
                                        <li>
                                            <p>143</p>
                                        </li>
        ...
        <div class="relative items-center flex bg-slate-50 gap-x-10">
            <div class="max-w-screen-2xl px-4 lg:px-16 mx-auto">
                <div class="flex flex-col gap-y-8 py-10">
                    <p class="">Në qytet, në zona bregdetare, rurale apo në vendndodhje të njohura – Hazaar është kudo me ju!
                        Zbuloni
                        <br>
                ...
                <div class="absolute top-0 left-0 flex max-w-screen-2xl px-4 lg:px-16 mx-auto bg-gray-200">
                    ...
                    <div class="px-20 hidden lg:flex"><img src="https://hazaar.eu/wp-content/uploads/2023/10/shigjeta.png" alt=""></div>
                </div>
            </div>
    ...
    <div class="flex flex-col gap-y-5 bg-slate-50 md:flex-row-reverse lg:hidden">
        ...
        <div class="max-w-screen-2xl px-4 lg:px-16 mx-auto flex flex-col gap-y-5 pb-3">
            ...
            <div>
                <p>Në qytet, në zona bregdetare, rurale apo në vendndodhje të njohura – Hazaar është kudo me ju! Zbuloni çdo pronë brenda perimetrit të ëndrrave tuaja. Lehtësoni kërkimin tuaj në çdo zonë të Shqipërisë.
                    Klikoni tani për një të ardhme të sigurt!</p>
            </div>
            <div><button class="bg-black text-green-500 px-5 py-3 rounded-md text-lg font-semibold">Eksploro tani</button></div>
        </div>
    </div>
